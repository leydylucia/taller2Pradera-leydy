...
<!DOCTYPE html>
  <html lang="es" >
    ...
    <body>
       ...
       <th><img src="objetos/localidad.gif"> </th><!--es el titulo notificacion-->
      </header> 
      ...
      <tbody>
        <?php foreach ($datos as $row): ?>
          <tr>
            ...
            <td><?php echo $row['hija'] ?></td>
			<td><?php echo $row['papa'] ?></td>
			
			<!--@link aqui se encuentra las rutas que conectan con el conttroller-->
			<td><a href="index.php?action=delete&amp;id=<?php echo $row['id'] ?>"><button type="submit">ELIMINAR</button></a>
            -<a href="index.php?action=update&amp;id=<?php echo $row['id'] ?>"><button type="submit">MODIFICAR</button></a> </td>
			</tr>
