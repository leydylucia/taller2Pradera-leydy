...
<!DOCTYPE html>
  <html lang="es" >
    ...
    <body>
       ...
       <th><img src="objetos/rh.gif"> </th><!--es el titulo notificacion-->
      </header> 
	  ...
	  <tbody>
        <?php foreach ($datos as $row): ?>
          <tr>
			...
			<td><a href="index.php?action=delete&amp;cod_rh=<?php echo $row['cod_rh'] ?>"><button type="submit">ELIMINAR</button></a>
            -<a href="index.php?action=update&amp;cod_rh=<?php echo $row['cod_rh'] ?>"><button type="submit">MODIFICAR</button></a> </td>
		  </tr>
